...
const CardRow = ({ img, cat, text, catId, postId }) => {
	return (
		<>
			<div className='relative shadow-lg rounded-lg group h-48 w-full flex justify-center overflow-hidden'>
				<div
					className='rounded-lg h-full w-full absolute z-10 bg-cover bg-center bg-no-repeat hover:opacity-50 transition-all duration-500 ease-in-out'
